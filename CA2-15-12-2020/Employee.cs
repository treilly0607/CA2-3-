...
namespace CA2_15_12_2020
{
    public abstract class Employee
    {
        ...
        public decimal MonthlyPay { get; set; } // surname property

        public abstract decimal CalculateMonthlyPay(); // abstract class for CalculateMonthlyPay
    ...
    public class FullTimeEmployee : Employee
    {
        ...
        public override decimal CalculateMonthlyPay() // override abstract method for MonthlyPay
        {
            MonthlyPay = Salary / 12m; // calc to find monthly pay of a Salary
